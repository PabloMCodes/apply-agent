...
async function profile() {
  ...
  function drawSavedAnswers(){
    ...
    if(!memory.length)library.append(el('p',{},'Answers you enter in desktop application tabs are saved here automatically when learning is enabled in Preferences.'));
  }
  drawSavedAnswers();
